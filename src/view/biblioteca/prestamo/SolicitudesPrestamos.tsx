            ...
            <div className="w-full max-w-full px-3 flex-0">
                <div className="flex flex-col visible w-full h-auto min-w-0 p-4 break-words bg-white opacity-100 border rounded-md bg-clip-border">
                    <div className="p-1 bg-Solid">
                        <h2 className="text-2xl font-bold mb-6"><span onClick={() => navigate(-1)} title="Atrás" role="button"><i className="bi bi-arrow-left-circle-fill text-blue-500"></i></span> Consultar Solicitudes</h2>
                        <div className="w-full">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                                <div>
                                    ...
                                    >
                                        Libros o Codigos <i className="bi bi-asterisk text-xs text-red-500"></i>
                                    </label>
                                    <input
                                        maxLength={8}
                                        type="text"
                            ...
                            <div className="relative overflow-auto rounded-md my-6">
                                <p className="text-lg font-bold m-1">LISTA DE SOLICITUDES</p>
                                <table className="w-full text-gray-700 uppercase bg-upla-100 border table-auto" id="miTabla">
                                    <thead className="align-bottom">
                                        <tr>
                                            ...
                                            <th className="px-6 py-2 font-bold text-center uppercase align-middle text-white text-xs">Solicitante</th>
                                            ...
                                            <th className="px-6 py-2 font-bold text-center uppercase align-middle text-white text-xs">Estado de la solicitud</th>
